...
export default function UsersPage() {
  ...
  const fetchUsers = async () => {
    try {
      setLoading(true);
      let result = await axios.get(apiSummary.admin.users.get_all_users);
  ...
  const handleAddUser = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(apiSummary.admin.users.add_new_user, {
  ...
  const handleEditUser = async (updatedUser) => {
    try {
      const response = await axios.post(
        apiSummary.admin.users.update_user_data,
        {
          id: updatedUser.id,
  ...
  const handleDeleteConfirmation = async (id) => {
    let response = await axios.post(apiSummary.admin.users.delete_user, { id });
