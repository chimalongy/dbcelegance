                    ...
                    {!isLoginFormVisible ? (
                        <div className="mt-4">
                            <button 
                                ...
                                className="border border-black text-black px-6 py-2 text-sm hover:bg-black hover:text-white transition-all duration-300"
                            >
                        ...
                        <div className="mt-6 w-full max-w-md mx-auto">
                            ...
                            <div className="text-xs text-gray-500 uppercase tracking-widest mb-4">OR</div>
                            ...
                            <form onSubmit={handleLogin} className="space-y-4">
                                ...
                                <button
                                    ...
                                    className={`w-full py-3 mt-2 text-white text-sm font-medium flex items-center justify-center space-x-2 transition-all ${
                                        isFormValid 
