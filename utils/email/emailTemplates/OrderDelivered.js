  ...
  getHtml(order) {
    ...
    const deliverySection = `
      <div style="margin-top:24px; text-align:left;">
        <h3 style="margin:0 0 8px 0; font-size:16px; font-weight:600;">Delivery Confirmation</h3>
        <p style="margin:0 0 8px 0; font-size:14px; color:#444;">
          Your order has been successfully delivered to:
        </p>
...
<head>
  ...
  <title>Your Order Has Been Delivered — DBC Elegance</title>
  <style>
    ${EmailStyles}
  </style>
</head>
<body style="margin:0; padding:0; background:#fff; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; color:#111;">
  ...
  <span style="display:none!important; visibility:hidden; mso-hide:all; font-size:1px; color:#fff; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">
    Your order has been delivered from DBC Elegance.
  </span>
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:600px; margin:0 auto;">
          ...
          <tr>
            <td align="center" style="padding: 24px 20px;">
              <h2 style="margin:0; font-size:22px; font-weight:600; text-transform:uppercase;">Your Order Has Been Delivered</h2>
              <p style="margin:16px 0; font-size:14px; color:#444; line-height:1.8;">
                Dear ${order.shipping_address.firstName},<br/><br/>
                We’re pleased to inform you that your order has been successfully delivered. We hope you love your new pieces!
              </p>
          ...
          <tr>
            <td align="center" style="padding: 32px 20px 20px 20px; border-top:1px solid #eee;">
              <h3 style="margin:0 0 12px 0; font-size:18px; font-weight:600;">Your Purchased Pieces</h3>
              <p style="margin:0 0 20px 0; font-size:13px; color:#666;">A reflection of timeless elegance:</p>
          ...
          <tr>
            <td align="center" style="padding: 24px 20px;">
              <p style="margin:0; font-size:14px; color:#555; line-height:1.6;">
                We’d love to hear from you! Share your thoughts or review your items to help us serve you better.
              </p>
              <a href="#" style="display:inline-block; margin-top:16px; padding:10px 20px; background:#111; color:#fff; text-decoration:none; border-radius:8px; font-size:14px; font-weight:600;">
                Leave a Review
              </a>
            </td>
          </tr>
  ...
  getText(order) {
    return `DBC Elegance — Order Delivered
...
We hope you love your purchase! If you’d like, please take a moment to share your feedback or leave a review.
