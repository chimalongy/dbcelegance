    ...
    <div className="h-full overflow-y-scroll mt-9 lg:px-12 px-4 py-6">
      <div className="h-fit">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-2">
              ...
              <div className="text-xs text-gray-500 mt-1">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li className={passwordRequirements.length ? 'text-green-500' : ''}>Minimum 8 characters</li>
            ...
            <div className="mb-4">
              ...
              <div className="flex">
                <select
                  ...
                  onChange={handleChange}
                  className="w-24 p-2 border border-gray-300 rounded-l"
                >
          ...
          {/* Preferences */}
          <section className="mb-6">
            <h2 className="text-lg font-semibold mb-4">Preferences & Terms *</h2>
            ...
            <div className="mb-3">
              <label className="flex items-start space-x-2">
                <input
                  ...
                  onChange={handleChange}
                />
                <span>I’d like to receive fashion news and updates from DBC Elegance Couture.</span>
              </label>
            </div>
            ...
            <div className="mb-4">
              <label className="flex items-start space-x-2">
                <input
                  ...
                  required
                />
                <span>I agree to store my shopping preferences to enhance future recommendations.</span>
              </label>
            </div>

            <p className="text-xs text-gray-500">
              By clicking “Create an account”, you confirm you’ve read and agree to the Privacy Policy, and consent to DBC Elegance Couture processing your personal data to manage your account. Your data may also be shared across our global network to offer you a personalized experience worldwide.
            </p>
          </section>
